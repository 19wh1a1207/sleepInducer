...
// import PauseIcon from '@mui/material/Icon';
        ...
        <div ref={textInput}>
            ...
            >
                <Toolbar>
                    ...
                    <Link to="/Login/Menu" style={{ color: "aquamarine", textDecoration: "none", fontFamily: ['Righteous'], marginRight:20}}>
                        Back
                    </Link>

                    {/* <IconButton coolor = "7FFFD4">
                        <PauseIcon color="#7FFFD4"/>
                    </IconButton> */}
                </Toolbar>
            </AppBar>
